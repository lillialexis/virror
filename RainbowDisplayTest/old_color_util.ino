...
int makeColor_old(HSV hsv) {
    return hsvToRgbInt_old(hsv);// makeColor(hsl.h, hsl.s, hsl.l);
}
...
//
int makeColor_old(unsigned int hue, unsigned int saturation, unsigned int lightness)
{
    ...
    if (saturation == 0) {
        ...
        red   = /*ColorCorrectLookup[min(*/h2rgb_old(var1, var2, (hue < 240) ? hue + 120 : hue - 240) * 255 / 600000/*, BYTE_MAX)]*/;
        green = /*ColorCorrectLookup[min(*/h2rgb_old(var1, var2, hue) * 255 / 600000/*, BYTE_MAX)]*/;
        blue  = /*ColorCorrectLookup[min(*/h2rgb_old(var1, var2, (hue >= 120) ? hue - 120 : hue + 240) * 255 / 600000/*, BYTE_MAX)]*/;
    }

    return (red << 16) | (green << 8) | blue;
}

unsigned int h2rgb_old(unsigned int v1, unsigned int v2, unsigned int hue)
{
